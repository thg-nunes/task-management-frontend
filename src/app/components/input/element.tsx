...
const INPUT_STYLES = {
  default:
    'bg-zinc-800 rounded-sm disabled:text-zinc-500 disabled:cursor-not-allowed border border-transparent focus-within:border-zinc-200 hover:border-zinc-200 pl-2 py-3 outline-none placeholder:text-zinc-400',
